...
private GitHub Security Advisory on this repository — the repository's **Security** tab, "Report a
vulnerability" (see [SECURITY.md](SECURITY.md)) — which is the private-reporting channel available
for this project. This applies to conduct reports as well as security reports; use it even though
the report itself is not a vulnerability. All complaints will be reviewed and investigated promptly
and fairly.
